...
$checks = @(
    ...
    'Temp/validate-inventory-organization-v20.json',
    'Temp/validate-save-safety-v21.json',
    'Temp/validate-crop-quality-v22.json',
    'Temp/validate-market-v23.json',
    'Temp/validate-land-v24.json'
)
...
Write-Output 'REGRESSION_V24_OK'
